...
class Plan(models.Model):
    ...
    plan_type = models.CharField(max_length=10, choices=PlanTypes.choices)
...
class Subscription(models.Model):
    ...
    comment = models.CharField(max_length=100, blank=True, db_index=True)
